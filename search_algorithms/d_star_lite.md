...
- [`documentation/d-star/related_algorithms.md`](../documentation/d-star/related_algorithms.md) — a backlog of algorithms adjacent to D* Lite (LPA*, Anytime D*, LRTA*) worth considering as follow-on toy examples

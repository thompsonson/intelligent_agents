...
- **Step 2 (AND-DAG topology, still binary state): design in progress.** `environment_design.md` written; `scenario.md` and `algorithm_fit.md` next, before any implementation.
